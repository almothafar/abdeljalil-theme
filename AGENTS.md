...
[`.github/PULL_REQUEST_TEMPLATE.md`](.github/PULL_REQUEST_TEMPLATE.md) is what GitHub prefills a description with. It asks for the things this repo cannot get any other way: which files a hand deploy has to copy, what was actually run to verify the change, and what was not verified. Delete the sections that do not apply rather than writing "n/a" under them, and replace a checklist with what you saw rather than ticking it because it should have worked.
